...
import com.example.repository.htu2CriteriaAPI.HTUData2RepositoryCriteriaAPI
...
@Service
@Transactional
open class HTUData2ServiceCriteriaAPI : HTUData2Service() {


    internal var HTUData2RepositoryCriteriaAPI: HTUData2RepositoryCriteriaAPI? = null
    ...
    @PostConstruct
    fun init() {
        HTUData2RepositoryCriteriaAPI = HTUData2RepositoryCriteriaAPI(entityManager as EntityManager)
    }
    ...
    override fun createHtu(HTUData2Bean: HTUData2Bean) {
        ...
        HTUData2RepositoryCriteriaAPI?.run{ createHtu(HTUData2) }
    }
    ...
    override fun findById(HTUData2Bean: HTUData2Bean): MutableList<HTUData2Bean> {
        ...
        val HTUData2 = HTUData2RepositoryCriteriaAPI?.run { findByid(HTUData2Bean) }
    ...
    override fun findAll(): MutableList<HTUData2Bean>  {
        ...
        val HTUData2List = HTUData2RepositoryCriteriaAPI?.run{ findAll() }
    ...
    override fun findMany(HTUData2Bean: HTUData2Bean): MutableList<HTUData2Bean> {
        ...
        val HTUData2List = HTUData2RepositoryCriteriaAPI?.run{ findMany(HTUData2Bean)}
        val HTUData2BeanList = HTUData2List?.run {
            val HTUData2BeanList = mutableListOf<HTUData2Bean>()
    ...
    override fun update(HTUData2Bean: HTUData2Bean) {
        ...
        HTUData2RepositoryCriteriaAPI?.run { update(HTUData2 as HTUData2) }
    }
    ...
    override fun delete(HTUData2Bean: HTUData2Bean) {
        ...
        val HTUData2lList = HTUData2RepositoryCriteriaAPI?.run {findMany(HTUData2Bean)}
        HTUData2lList?.let { if(it?.size != 0) it.forEach {HTUData2 -> HTUData2RepositoryCriteriaAPI?.delete(HTUData2) }}
    }
}
